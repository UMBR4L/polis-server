  ...
  try {
    const requestData = {
      ...
      messages: [
        {
          role: "system",
          content: `Simplify the language of the provided JSON to a 7th-grade comprehension level. Your responses should always produce JSON with the following keys and relevant values: 'Name', 'Intent', 'Changes', 'Pros', 'Cons', 'Progress'.`,
        },
        {
          role: "user",
